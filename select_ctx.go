...
func (d *selectData) ExecContext(ctx context.Context) (pgconn.CommandTag, error) {
	if d.RunWith == nil {
...
func (d *selectData) QueryContext(ctx context.Context) (pgx.Rows, error) {
	if d.RunWith == nil {
		return nil, RunnerNotSet
	}
...
func (d *selectData) QueryRowContext(ctx context.Context) pgx.Row {
	if d.RunWith == nil {
